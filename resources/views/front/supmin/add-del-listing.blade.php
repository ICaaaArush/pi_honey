...
<div class="container-fluid">
  <form action="{{route('add-del-com')}}" method="post">
    ...
    <div class="form-group">
      <label for="inputAddress2">Delivery Charge</label>
      <input type="number" step="0.01" class="form-control" id="inputAddress2" name="delivery_charge" placeholder="Enter Charge">
    </div>
